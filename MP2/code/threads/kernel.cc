...
bool Kernel::frametable[NumPhysPages]={false};

void Kernel::releaseframe(int i){
    //cout<<"aaa";
    //for(int i=0;i<NumPhysPages;i++)
    Kernel::frametable[i]=false;
}


int Kernel::findfreeframe(){
    int i=0;
    
    while(i<NumPhysPages && Kernel::frametable[i]==true)i++;
    
    if(i==NumPhysPages){
      //cout<<"no frame left!"<<endl;
